...
export type ResolversTypes = {
  ...
  PlaceProperties: ResolverTypeWrapper<
    Omit<PlaceProperties, "reviews"> & {
      reviews: Array<ResolversTypes["Review"]>;
    }
  >;
  PlaceReviews: ResolverTypeWrapper<
    Omit<PlaceReviews, "reviews"> & { reviews: Array<ResolversTypes["Review"]> }
  >;
...
export type ResolversParentTypes = {
  ...
  Mutation: {};
  Place: IPlace;
  PlaceProperties: Omit<PlaceProperties, "reviews"> & {
    reviews: Array<ResolversParentTypes["Review"]>;
  };
  PlaceReviews: Omit<PlaceReviews, "reviews"> & {
    reviews: Array<ResolversParentTypes["Review"]>;
  };
  Query: {};
  Review: IInteraction;
...
export type AddRatingResponseResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["AddRatingResponse"] = ResolversParentTypes["AddRatingResponse"],
> = {
...
export type AddTextReviewResponseResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["AddTextReviewResponse"] = ResolversParentTypes["AddTextReviewResponse"],
> = {
  reviewId?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type CharacteristicCountsResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["CharacteristicCounts"] = ResolversParentTypes["CharacteristicCounts"],
> = {
  affordablePrices?: Resolver<
    ResolversTypes["CharacteristicData"],
    ParentType,
    ContextType
  >;
  deliciousFilterCoffee?: Resolver<
    ResolversTypes["CharacteristicData"],
    ParentType,
    ContextType
  >;
  freeWifi?: Resolver<
    ...
    ContextType
  >;
  friendlyStaff?: Resolver<
    ResolversTypes["CharacteristicData"],
    ParentType,
    ContextType
  >;
  outdoorSeating?: Resolver<
    ResolversTypes["CharacteristicData"],
    ParentType,
    ContextType
  >;
  petFriendly?: Resolver<
    ResolversTypes["CharacteristicData"],
    ParentType,
    ContextType
  >;
  pleasantAtmosphere?: Resolver<
    ResolversTypes["CharacteristicData"],
    ParentType,
    ContextType
  >;
...
export type CharacteristicDataResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["CharacteristicData"] = ResolversParentTypes["CharacteristicData"],
> = {
...
export type DeleteReviewResultResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["DeleteReviewResult"] = ResolversParentTypes["DeleteReviewResult"],
> = {
  averageRating?: Resolver<ResolversTypes["Float"], ParentType, ContextType>;
  ratingCount?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
...
> = {
  addRating?: Resolver<
    ResolversTypes["AddRatingResponse"],
    ParentType,
    ContextType,
    RequireFields<MutationAddRatingArgs, "placeId" | "rating">
  >;
  addTextReview?: Resolver<
    ResolversTypes["AddTextReviewResponse"],
    ParentType,
    ContextType,
    RequireFields<MutationAddTextReviewArgs, "placeId" | "text">
  >;
  ...
  deleteReview?: Resolver<
    ResolversTypes["DeleteReviewResult"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteReviewArgs, "deleteOptions" | "reviewId">
  >;
  loginWithGoogle?: Resolver<
    Maybe<ResolversTypes["AuthPayload"]>,
    ParentType,
    ContextType,
    RequireFields<MutationLoginWithGoogleArgs, "code">
  >;
  logout?: Resolver<
  ...
  setNewPassword?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationSetNewPasswordArgs, "newPassword" | "userId">
  >;
  signInWithEmail?: Resolver<
    ResolversTypes["AuthPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationSignInWithEmailArgs, "email" | "password">
  >;
  toggleCharacteristic?: Resolver<
    ResolversTypes["SuccessResponse"],
    ParentType,
    ContextType,
    RequireFields<
      MutationToggleCharacteristicArgs,
      "characteristic" | "placeId"
    >
  >;
  toggleFavorite?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationToggleFavoriteArgs, "placeId">
  >;
  updatePersonalData?: Resolver<
    ResolversTypes["SuccessResponse"],
    ParentType,
    ContextType,
    RequireFields<MutationUpdatePersonalDataArgs, "userId">
  >;
  uploadAvatar?: Resolver<
    ResolversTypes["SuccessResponse"],
    ParentType,
    ContextType,
    RequireFields<MutationUploadAvatarArgs, "fileUrl" | "userId">
  >;
};
...
> = {
  ...
  properties?: Resolver<
    ResolversTypes["PlaceProperties"],
    ParentType,
    ContextType
  >;
  type?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type PlacePropertiesResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["PlaceProperties"] = ResolversParentTypes["PlaceProperties"],
> = {
  ...
  averageRating?: Resolver<
    ...
    ContextType
  >;
  characteristicCounts?: Resolver<
    ResolversTypes["CharacteristicCounts"],
    ParentType,
    ContextType
  >;
...
export type PlaceReviewsResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["PlaceReviews"] = ResolversParentTypes["PlaceReviews"],
> = {
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  reviews?: Resolver<Array<ResolversTypes["Review"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
> = {
  currentUser?: Resolver<
    ...
    ContextType
  >;
  getUserReviewActivity?: Resolver<
    Array<ResolversTypes["UserReviewActivity"]>,
    ParentType,
    ContextType
  >;
  placeReviews?: Resolver<
    ResolversTypes["PlaceReviews"],
    ParentType,
    ContextType,
    RequireFields<QueryPlaceReviewsArgs, "placeId">
  >;
...
> = {
  ...
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  isGoogleUserUserWithoutPassword?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType
  >;
...
export type UserReviewActivityResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["UserReviewActivity"] = ResolversParentTypes["UserReviewActivity"],
> = {
  averageRating?: Resolver<
    Maybe<ResolversTypes["Float"]>,
    ParentType,
